...
const Sidebar = () => {
  ...
  const [isControlDisabled, setControlDisabled] = useState(true); // Add disabled state for Control
  const [isOptimizeDisabled, setOptimizeDisabled] = useState(true); // Add disabled state for Optimize
  ...
  const disabledLink =
    'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-400 cursor-not-allowed m-2';
      ...
      <>
        ...
        <div className="mt-10 mx-auto">
          ...
          <div className="mt-3">
            <div
              className={`flex items-center justify-between p-3 ${
                isControlDisabled ? disabledLink : normalLink
              }`}
              onClick={() => !isControlDisabled && setControlOpen(!isControlOpen)}
            >
              <div className="flex items-center gap-5">
          ...
          <NavLink
            ...
            className={({ isActive }) => (isActive ? activeLink : normalLink)}
            onClick={scrollToTop}
            style={isOptimizeDisabled ? { pointerEvents: 'none' } : {}}
          >
