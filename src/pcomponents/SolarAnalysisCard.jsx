...
import solaranalysis from "../pictures/solaranalysis.png";
import solaranalysis2 from "../pictures/solaranalysis2.png";
    ...
    <div className="bg-white rounded-2xl p-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col items-center">
          <img src={solaranalysis2} alt="Solar Energy Visualization 2" className="w-full h-[350px]" />
          <p className="text-sm text-gray-500 mt-2">Building Solar Energy Visualization 2</p>
        </div>
        <div className="flex flex-col items-center">
          <img src={solaranalysis} alt="Solar Energy Visualization 1" className="w-full h-[350px]" />
