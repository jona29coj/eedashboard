...
import dg from "../pictures/dg.png"; // Generator Image
...
const Dgd = () => {
  ...
  const generatorDetails = {
    name: `DG${id}`,
    status: id === "1" ? "Running" : id === "2" ? "Idle" : "Stopped",
    fuelLevel: id === "1" ? "75%" : id === "2" ? "50%" : "30%",
    lastMaintenance: id === "1" ? "12 Jan 2024" : id === "2" ? "05 Feb 2024" : "20 Jan 2024",
    runtime: id === "1" ? "1200 hours" : id === "2" ? "800 hours" : "600 hours",
    location: id === "1" ? "Zone A" : id === "2" ? "Zone B" : "Zone C",
  };
        ...
        <div className="lg:w-1/3 p-6 border-r border-gray-300"> {/* Add border-right for partition */}
          ...
          <div className="text-lg text-gray-700 space-y-2">
            <p>
              ...
              <span className={
                generatorDetails.status === "Running" ? "text-green-600" : 
                generatorDetails.status === "Idle" ? "text-yellow-600" : 
                "text-red-600"
              }>
