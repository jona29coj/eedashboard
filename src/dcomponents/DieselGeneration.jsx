...
import dg from "../pictures/dg.png";
  ...
  return (
    <div className="rounded-lg shadow-lg bg-white w-full border border-gray-300 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* DG3 Section */}
        <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-lg shadow-sm">
          <img className="w-40 h-40 object-contain rounded-lg mb-4" src={dg} alt="DG3" />
          <h2 className="font-bold text-2xl text-gray-800 mb-2">DG3</h2>
          <div className="text-gray-700 text-sm space-y-2">
            <p><strong>Status:</strong> <span className="text-red-600">Stopped</span></p>
            <p><strong>Power Output:</strong> 250 kW</p>
            <p><strong>Fuel Level:</strong> 30%</p>
            <p><strong>Last Maintenance:</strong> 20 Jan 2024</p>
          </div>
          <button 
            onClick={() => navigate('/generator/3')}
            className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg transition-all"
          >
            View Details
          </button>
